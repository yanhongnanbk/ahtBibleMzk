package com.yan.ahtbibleaudio002.externalSource.services;
...
import com.yan.ahtbibleaudio002.externalSource.receiver.ControlActionsListener
import com.yan.ahtbibleaudio002.externalSource.receiver.HeadsetPlugReceiver
import com.yan.ahtbibleaudio002.externalSource.receiver.RemoteControlReceiver
import com.yan.ahtbibleaudio002.models.AudioItem
import com.yan.ahtbibleaudio002.views.ui.DetailActivity
import java.util.*
...
class MusicService : Service(), MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnCompletionListener, AudioManager.OnAudioFocusChangeListener {
    companion object {
        ...
        private var mSongs = ArrayList<AudioItem>()
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        ...
        when (intent.action) {
            INIT -> {
                ...
                Thread {
                    ...
                    if (!isServiceInitialized) {
                        initService()
                        mSongs = intent.getSerializableExtra("list") as ArrayList<AudioItem>
                        mCurrSong = intent.getSerializableExtra("detail") as AudioItem
            ...
            EDIT -> {
                mCurrSong = intent.getSerializableExtra(EDITED_SONG) as AudioItem
...
//        }
    ...
    private fun setSong(songIndex: Int, addNewSongToHistory: Boolean) {
        ...
        try {
            ...
            mPlayer!!.setDataSource(mCurrSong!!.fileUrl)
    ...
    private fun songChanged(song: AudioItem?) {
